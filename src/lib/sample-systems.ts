    ...
    customBrackets: [
      {
        ...
        workActivityRefs: [
          { id: 'fab_swage', workActivityRateId: '',
            timeFormula: 'anchor_qty * 25', timeUnit: 'min' as const,
            _categoryName: 'Fabrication', _categoryIcon: '🔧', _rateName: '', _rateValue: 0,
            _rateUnitType: 'per_hour' as const, _rateUnitLabel: 'hr' },
        ],
      },
    ],
    setupBrackets: [
    ...
    workActivities: [
      {
        ...
        crewSize: 2, _categoryName: 'Installation',
        criteriaKeys: [],
      } satisfies WorkActivity,
      {
        ...
        crewSize: 2, _categoryName: 'Commissioning',
        criteriaKeys: [],
      } satisfies WorkActivity,
    ],
    ...
    customBrackets: [
      {
        ...
        workActivityRefs: [
          { id: 'fab_hoop', workActivityRateId: '',
            timeFormula: 'hoop_qty * 8', timeUnit: 'min' as const,
            _categoryName: 'Fabrication', _categoryIcon: '🔧', _rateName: '', _rateValue: 0,
            _rateUnitType: 'per_hour' as const, _rateUnitLabel: 'hr' },
        ],
      },
    ...
    customBrackets: [
      {
        ...
        workActivityRefs: [
          { id: 'fab_post', workActivityRateId: '',
            timeFormula: 'bays * 8', timeUnit: 'min' as const,
            _categoryName: 'Fabrication', _categoryIcon: '🔧', _rateName: '', _rateValue: 0,
            _rateUnitType: 'per_hour' as const, _rateUnitLabel: 'hr' },
        ],
      },
